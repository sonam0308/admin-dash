                                        ...
                                        <div className="row g-3 mb-3">
                                                ...
                                                <div className="card ">
                                                    <div className="card-body">
                                                        <div className="d-flex align-items-center">
                                                            <div className="avatar lg  rounded-1 no-thumbnail bg-lightyellow color-defult"><i className="icofont-optic fs-4" /></div>
                                            ...
                                            <div className="col-md-4">
                                                <div className="card ">
                                                    <div className="card-body">
                                                        <div className="d-flex align-items-center">
                                                            <div className="avatar lg  rounded-1 no-thumbnail bg-lightblue color-defult"><i className="icofont-user fs-4" /></div>
                                                            <div className="flex-fill ms-4 text-truncate">
                                            ...
                                            <div className="col-md-4">
                                                <div className="card ">
                                                    <div className="card-body">
                                                        <div className="d-flex align-items-center">
                                                            <div className="avatar lg  rounded-1 no-thumbnail bg-lightgreen color-defult"><i className="icofont-price fs-4" /></div>
                                                            <div className="flex-fill ms-4 text-truncate">
                                                                ...
                                                                <div className="flex-grow-1">
                                                                    <div className="py-2 d-flex align-items-center border-bottom">
                                                                        <div className="d-flex ms-3 align-items-center flex-fill">
                                                                            <span className="avatar lg light-danger-bg rounded-circle text-center d-flex align-items-center justify-content-center"><i className="icofont-bug fs-5" /></span>
                                                        ...
                                                        <div className="card">
                                                            <div className="card-body">
                                                                ...
                                                                <div className="flex-grow-1">
                                                                    <div className="py-2 d-flex align-items-center border-bottom">
                                                                        <div className="d-flex ms-3 align-items-center flex-fill">
                                                                            <span className="avatar lg bg-lightgreen rounded-circle text-center d-flex align-items-center justify-content-center"><i className="icofont-file-pdf fs-5" /></span>
                                                                            <div className="d-flex flex-column ps-3">
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-12 col-md-12">
                                                        ...
                                                        <div className="card mb-2">
                                                            <div className="card-body">
                                                                <div className="post">
                                                                    <textarea className="form-control" placeholder="Post" rows={4} defaultValue={""} />
                                                                    <div className="py-3">
                                                                ...
                                                                <div className="card-body">
                                                                    ...
                                                                    <div className="timeline-item-post">
                                                                        ...
                                                                        <div className="mb-2 mt-4">
                                                                            <a className="me-lg-4 me-2 text-primary" href="#"><i className="icofont-speech-comments" /> Comment (2)</a>
                                                                        </div>
                                                                        <div>
                                                                    ...
                                                                    <div className="mt-4">
                                                                        <textarea className="form-control" placeholder="Replay" defaultValue={""} />
                                                                    </div>
                                                                </div>
                                                            </li> {/* .Card End */}
                                                        </ul>
